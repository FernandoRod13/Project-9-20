...
class ResourceDAO:
    ...
    def getResourcesbyName_Description(self,name,description):
        ...
        for row in cursor:
            result.append(row)
        #Get Resources requested
        query = "Select requested_name , type_name as category, account_id, description, class , quantity, city_name from resources_requested natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City where lower(description) LIKE '%%' || %s || '%%' and lower(requested_name)= %s order by requested_name  ;"
        cursor.execute(query,(description,name) )
        for row in cursor:
            result.append(row)        
        return result
    ...
    def getResourcesbyRegion(self, Region):
        cursor = self.conn.cursor()
        #Get Resources avaliable
        query = "Select resource_name , type_name as category, account_id, description, class , quantity, city_name from Resources natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City natural inner join Region where region_name = %s order by resource_name   ;"
    ...
    def getResourcesbyCity(self, City):
        cursor = self.conn.cursor()
        #Get Resources avaliable
        query = "Select resource_name , type_name as category, account_id, description, class , quantity, city_name from Resources natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City where city_name = %s  order by resource_name ;"
        cursor.execute(query,(City,) )
        result = []
        for row in cursor:
            result.append(row)
        #Get Resources requested
        query = "Select requested_name , type_name as category, account_id, description, class , quantity, city_name from resources_requested natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City  where city_name = %s  order by requested_name;"
        cursor.execute(query,(City,) )
        for row in cursor:
            result.append(row)        
        return result
    ...
    def getResourcesbyCity_Name(self, City,name):
        cursor = self.conn.cursor()
        #Get Resources avaliable
        query = "Select resource_name , type_name as category, account_id, description, class , quantity, city_name from Resources natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City natural inner join region where city_name = %s and lower(resource_name)= %s order by resource_name  ;"
        cursor.execute(query,(City,name,) )
        result = []
        for row in cursor:
            result.append(row)
        #Get Resources requested
        query = "Select requested_name , type_name as category, account_id, description, class , quantity, city_name from resources_requested natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City natural inner join region  where city_name = %s and lower(requested_name)= %s  order by requested_name;"
        cursor.execute(query,(City,name,) )
        for row in cursor:
            result.append(row)        
        return result
    ...
    def getResourcesbyKeywords(self, keywords):
        cursor = self.conn.cursor()
        #Get Resources avaliable
        query = "Select resource_name , type_name as category, account_id, description, class , quantity ,city_name from Resources natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City natural inner join resource_keyword where lower(keyword) LIKE '%%' || %s || '%%' order by resource_name  ;"
        cursor.execute(query, (keywords,))
        result = []
        for row in cursor:
            result.append(row)
        #Get Resources requested
        query = "Select requested_name , type_name as category, account_id, description, class , quantity,city_name from Resources_requested natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City  natural inner join resources_requested_keywords where lower(keyword) LIKE '%%' || %s || '%%'  order by requested_name;"
        cursor.execute(query, (keywords,))
        for row in cursor:
            result.append(row)        
        return result
    ...
    def getAllResourcesbyKeywords_City(self, keywords, city):
        cursor = self.conn.cursor()
        #Get Resources avaliable
        query = "Select resource_name , type_name as category, account_id, description, class , quantity,city_name from Resources natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City natural inner join resource_keyword where city_name = %s and lower(keyword) LIKE '%%' || %s || '%%' order by resource_name  ;"
        cursor.execute(query,(city,keywords,) )
        result = []
        for row in cursor:
            result.append(row)
        #Get Resources requested
        query = "Select requested_name , type_name as category, account_id, description, class , quantity,city_name from resources_requested natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City  natural inner join resources_requested_keywords where city_name = %s and lower(keyword) LIKE '%%' || %s || '%%'  order by requested_name;"
        cursor.execute(query,(city,keywords,) )
        for row in cursor:
            result.append(row)        
        return result
    ...
    def getAllResourcesbyQty(self, qty):
        cursor = self.conn.cursor()
        #Get Resources avaliable
        query = "Select resource_name , type_name as category, account_id, description, class , quantity,city_name  from Resources natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City where quantity= %s order by resource_name ;"
        ...
        #Get Resources requested
        query = "Select requested_name , type_name as category, account_id, description, class , quantity,city_name from resources_requested natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City where quantity= %s order by requested_name ;"
        cursor.execute(query,(qty,))
        for row in cursor:
            result.append(row)        
        return result
...
#############################################################################
    ...
    def getAllResourcesRequestedbyQty(self, qty):
        cursor = self.conn.cursor()
        #Get Resources requested
        query =  "Select requested_name , type_name as category, account_id, description,  quantity, creation_date ,city_name  from resources_requested natural inner join Resource_Type natural inner join Accounts natural inner join Location natural inner join City where quantity = %s order by requested_name ;"
        cursor.execute(query,(qty,))
        result = []
        for row in cursor:
            result.append(row)        
